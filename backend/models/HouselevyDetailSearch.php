...
/**
 * HouselevyDetailSearch represents the model behind the search form about `app\models\HouselevyDetail`.
 */
class HouselevyDetailSearch extends HouselevyDetail
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'houselevy_list_id', 'dictionaries_id', 'parent_id'], 'integer'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            'id' => $this->id,
            'houselevy_list_id' => $this->houselevy_list_id,
