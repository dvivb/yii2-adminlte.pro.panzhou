    ...
    <div class='text-center'>
        <div class='col-lg-12'>
            <div class='box box-primary'>
                ...
                echo Html::a('增加', ['/landlist/landlist/add/'.$id],['class'=>'btn btn-primary edit-sms-template']).'&nbsp;&nbsp;&nbsp;';
                echo '</div>';
                    ...
                    'columns' => [
                            ...
                            'do_action' =>[
                                            ...
                                            'value' => function ($data) {
                                                        $buttonStr = '';
                                                        if($data->status == 0)
                                                        $buttonStr .=  Html::a('申请拨款', ['/landlist/landlist/apply/'.$data->id.'/'.$data->project_id],['class'=>'btn btn-primary edit-sms-template']).'&nbsp;&nbsp;&nbsp;';
                                                        $buttonStr .=  Html::a('详情',['/member/member/'.$data->id], ['class'=>'btn btn-primary edit-sms-template']).'&nbsp;&nbsp;&nbsp;';
                                                        $buttonStr.=Html::a('删除',['/landlist/landlist/del/'.$data->id.'/'.$data->project_id],  ['class'=>'btn update-sms-template-del btn-primary']).'&nbsp;&nbsp;&nbsp;';
